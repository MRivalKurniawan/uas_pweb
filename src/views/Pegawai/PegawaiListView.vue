<template>
  <section class="hero is-small">
    <div class="hero-body">
      ...
      <p class="subtitle">
        Menampilkan Data pegawai,id pegawai serta nama pegawai,juga menyediakan menu create data baru, update data dan delete data.
        API endpoint
      </p>
    </div>
  </section>
        ...
        <tr v-if="data.length" v-for="(value, index) in data">
          ...
          <td>
            <div class="field has-addons">
              <p class="control">
                <RouterLink class="button is-success" :to="{ name: 'Pegawai-detail', params: { nip:  value.nip}}">
                  <span class="icon is-small">
  ...
  methods:{
    ...
    remove(){
      ...
      if(this.selectedIndex >= 0){
        ...
        fetch(`https://projectbersama.my.id/pages/dosen/delete.php`,{
          method: 'DELETE',
          headers: {
    ...
    update(){
      ...
      if(this.selectedIndex >= 0){
        ...
        fetch(`https://projectbersama.my.id/pages/dosen/update.php`,{
          method: 'PATCH',
          headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
            'API-Key': 'secret'
    ...
    addNew(){
      ...
      fetch(`https://projectbersama.my.id/pages/dosen/create.php`,{
        method: 'POST',
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded',
          'API-Key': 'secret'
...
.table{
  box-shadow: 0 3px 10px rgb(61, 43, 43);
}
</style>