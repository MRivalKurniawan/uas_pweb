<template>
  <section class="hero is-small">
    <div class="hero-body">
      ...
      <p class="subtitle">
        Menampilkan Nama Pelanggan,ID Pelanggan, dan juga menyediakan menu create data baru, update data dan delete data. API endpoint
      </p>
    </div>
  </section>
        ...
        <tr v-if="data.length" v-for="(value, index) in data">
          ...
          <td>
            <div class="field has-addons">
              <p class="control">
                <RouterLink class="button is-success" :to="{ name: 'Pelanggan-detail', params: { nim:  value.nim}}">
                  <span class="icon is-small">
...
export default {
  ...
  methods:{
    load(){
      ...
      fetch(`https://projectbersama.my.id/pages/mahasiswa/index.php`,{
        method: 'GET',
      })
        .then(response => {
          if(response.ok){
    ...
    loadDosen(){
      this.isLoading = true;
      //const baseurl = import.meta.env.VITE_URL_ENDPOINT_2;
      fetch(`https://projectbersama.my.id/pages/dosen/index.php`,{
        method: 'GET',
      })
        .then(response => {
          if(response.ok){
    ...
    loadMatakuliah(){
      this.isLoading = true;
      //const baseurl = import.meta.env.VITE_URL_ENDPOINT_2;
      fetch(`https://projectbersama.my.id/pages/matakuliah/index.php`,{
        method: 'GET',
      })
        .then(response => {
          if(response.ok){
    ...
    remove(){
      ...
      if(this.selectedIndex >= 0){
        ...
        fetch(`https://projectbersama.my.id/pages/mahasiswa/delete.php`,{
          method: 'DELETE',
          headers: {
    ...
    update(){
      ...
      if(this.selectedIndex >= 0){
        ...
        fetch(`https://projectbersama.my.id/pages/mahasiswa/update.php`,{
          method: 'PATCH',
          headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
            'API-Key': 'secret'
    ...
    addNew(){
      ...
      fetch(`https://projectbersama.my.id/pages/mahasiswa/create.php`,{
        method: 'POST',
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded',
          'API-Key': 'secret'
