<template>
  <section class="hero is-small">
    <div class="hero-body">
      ...
      <p class="subtitle">
        Menampilkan Data Kamar yang tersedia,serta menyediakan menu create data, update data dan delete data. API endpoint
      </p>
    </div>
  </section>
        ...
        <tr v-if="data.length" v-for="(value, index) in data">
          ...
          <td>
            <div class="field has-addons">
              <p class="control">
                <RouterLink class="button is-success" :to="{ name: 'Kamar-detail', params: { kodemk:  value.kodemk}}">
                  <span class="icon is-small">
  ...
  methods:{
    ...
    remove(){
      ...
      if(this.selectedIndex >= 0){
        ...
        fetch(`https://projectbersama.my.id/pages/matakuliah/delete.php`,{
          method: 'DELETE',
          headers: {
    ...
    update(){
      ...
      if(this.selectedIndex >= 0){
        ...
        fetch(`https://projectbersama.my.id/pages/matakuliah/update.php`,{
          method: 'PATCH',
          headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
            'API-Key': 'secret'
    ...
    addNew(){
      ...
      fetch(`https://projectbersama.my.id/pages/matakuliah/create.php`,{
        method: 'POST',
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded',
          'API-Key': 'secret'
